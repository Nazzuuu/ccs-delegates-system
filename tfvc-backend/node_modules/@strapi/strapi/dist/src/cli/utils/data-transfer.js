...
const excludeOption = new commander.Option('--exclude <comma-separated data types>', `Exclude data: ${transferFilterPresetsHelp}`).argParser(commander$1.getParseListWithChoices(transferDataTypes, 'Invalid options for "exclude"'));
const onlyOption = new commander.Option('--only <command-separated data types>', `Include only these types (plus schemas): ${transferFilterPresetsHelp}`).argParser(commander$1.getParseListWithChoices(transferDataTypes, 'Invalid options for "only"'));
