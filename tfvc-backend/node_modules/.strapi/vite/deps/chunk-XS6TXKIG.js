import {
  ...
  HOOKS
} from "./chunk-FIKB3MFG.js";
import {
  useNpsSurveySettings
} from "./chunk-FCJ27RU7.js";
import {
  require_pick
} from "./chunk-CIKRVPYW.js";
import {
  getBasename
} from "./chunk-TKXHHSNW.js";
import {
  Login
} from "./chunk-5Z4OCUJA.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-JF2YXGDV.js";
import {
  ConfigurationProvider
} from "./chunk-MU3XTMFL.js";
import {
  useClipboard
} from "./chunk-PUO4Z3RA.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-UHTS5LIN.js";
import {
  useGetAiUsageQuery
} from "./chunk-TXQWTJEO.js";
import {
  useEnterprise
} from "./chunk-7MO7L32J.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-56LACPBQ.js";
import {
  require_baseRest
} from "./chunk-ZJCTND2Z.js";
import {
  HistoryProvider
} from "./chunk-HTW3RZJT.js";
import {
  _setPrototypeOf
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-2H5CDXMF.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-2IRG5XKX.js";
import {
  MemoizedInputRenderer
} from "./chunk-FJROOSKM.js";
import {
  Form
} from "./chunk-WPM7JWMA.js";
import {
  Layouts
} from "./chunk-5U5EFMAX.js";
import {
  getByteSize
...
import {
  ...
  TrackingProvider,
  useTracking
} from "./chunk-3ED3YA5Q.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-4GG6X3TE.js";
import {
  require_isEqual
...
import {
  ...
  useTypedSelector,
  useTypedStore
} from "./chunk-EWBGXVVO.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-YPRZDW5I.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-GFNNIO2V.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-65YRW3ZX.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await retryDynamicImport(() => import("./Login-I3AY5JR6.js"))).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await retryDynamicImport(() => import("./constants-V2ONBSAL.js"))).FORMS, {
...
var ADMIN_TOKEN_ROUTES = [
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-XQQNITRA.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-2MLFXXOU.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-DX4VXUD7.js");
      return {
...
var ROUTES_CE = () => [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-GKGEQ5LA.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-VG2VXCXK.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-A2PT6WHL.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-YEYNXHLT.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-FC4I4JAM.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-MKDBL6OO.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-RRAUPM3C.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-IRQUHV3F.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-OGZ3XNPZ.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-3ILLQPGD.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-K5TPVJ6Q.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-PTYEEHMA.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-SZ5CZAYP.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-JMOZANGF.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-ZPCY5XRL.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-KKZ2O3ZX.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-PYM66RIO.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-QY2K3RCT.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-3BBEOTOC.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-SXLP423C.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-4GNSVILQ.js");
      return {
  ...
  },
  {
    path: "me/sessions",
    lazy: async () => {
      const { SessionsPage } = await import("./SessionsPage-BNTFC3RW.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-TXJ7LUX6.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-ZFWXCPQ6.js");
          return {
  ...
  */
  createRouter(strapi, { memory, ...opts } = {}) {
    const authenticatedLayoutRoute = {
      path: "/*",
      lazy: async () => {
        const { PrivateAdminLayout } = await import("./AuthenticatedLayout-EOU77KL2.js");
        return {
  ...
  async register(customRegister) {
    const widgets = [
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-AI4IZCI3.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-AI4IZCI3.js");
    ...
    if ("strapi-cloud" in this.appPlugins) {
      widgets.push({
        ...
        component: async () => {
          const { DeployNowWidget } = await import("./Widgets-AI4IZCI3.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-IVYXFAFB.js");
...
//# sourceMappingURL=chunk-XS6TXKIG.js.map
