...
import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-SLHPID24.js";
import {
  getStageColorByHex
} from "./chunk-32IWABTM.js";
import {
  LimitsModal,
  useReviewWorkflows
} from "./chunk-Z6WTJRGT.js";
import {
...
} from "./chunk-J6ZMAY2G.js";
import {
  index
} from "./chunk-GGRUSMMS.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-TOFVNKIS.js";
import {
  useConfig
} from "./chunk-RSZGJPCY.js";
import {
  Drawer,
  abortUpload,
  cancelUpload,
...
} from "./chunk-66LJOAF3.js";
import {
  ASSET_TYPES
} from "./chunk-7GZQ6DOF.js";
import {
  ASSET_SOURCES,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-32EANEZZ.js";
import {
  pluginId
} from "./chunk-5QJFIL32.js";
import {
  useDocumentActions
} from "./chunk-K35D73UT.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-L7WJLCIJ.js";
import {
  renderAdmin,
  require_baseUniq,
  useDebounce
...
import {
  Table,
  useTable
} from "./chunk-YQ5LRYDY.js";
import {
  useRBAC
} from "./chunk-KI4SASRC.js";
import {
  useAdminUsers
} from "./chunk-QKQCKBET.js";
import {
  K,
  Page,
  useAPIErrorHandler
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-EBQNCMGY.js");
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-KC6KLPMJ.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
var admin = {
  ...
  register(app) {
    app.addSettingsLink({
      ...
      id: "settings",
      to: "email",
      Component: () => import("./Settings-GAV6BINS.js").then((mod) => ({
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-EAOA4VFI.js");
    case "./translations/es.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-IWTTWANZ.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-WOTVQDZL.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      Component() {
        return import("./SettingsPage-SSXGQURR.js").then((mod) => ({
          default: mod.ProtectedSettingsPage
        }));
      },
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-PUOWX7ZW.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-STYP6BO5.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./ReleasesSettingsPage-AKSDE4CQ.js").then((mod) => ({
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-ZSKHEDAQ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./PurchaseContentReleases-SJS36BCC.js").then((mod) => ({
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./router-V2IZDQ24.js").then((mod) => ({
            default: mod.Router
          }));
        }
      });
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-4NJQ5UO6.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./purchase-review-workflows-2WV5DE76.js").then((mod) => ({
...
//# sourceMappingURL=chunk-FX5VEAGS.js.map
